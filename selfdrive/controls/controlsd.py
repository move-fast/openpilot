...
class Controls:
  ...
  def publish_logs(self, CS, start_time, actuators, v_acc, a_acc, lac_log):
    ...
    controlsState.speedLimitOffset = float(self.sm['plan'].speedLimitOffset)
    ...
    controlsState.decelForModel = self.sm['plan'].decelForTurn  # self.sm['plan'].longitudinalPlanSource == LongitudinalPlanSource.model
